...
public class CE49AbstractClass {
    public static void main(String[] args) {
        ...
        String stringData = "5 6 3 2 7 0 9 1 4 8";
        ...
        // Create a string data array to avoid typing loads of addItem instructions:
        //String stringDataforTree = "Darwin Brisbane Perth Melbourne Canberra Adelaide Sydney Canberra";
        String stringDataforTree = "5 7 3 9 8 2 1 0 4 6";
        String[] datafortree = stringDataforTree.split(" ");
        for (String s : datafortree) {
            // create new item with value set to the string s
